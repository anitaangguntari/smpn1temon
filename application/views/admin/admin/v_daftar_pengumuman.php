        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3>Daftar Pengumuman&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/pengumuman/tambah') ; ?>"class="btn btn-info">+</a></h3>
            <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url('admin/pengumuman/edit/'.$p->id_pengumuman) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('admin/pengumuman/delete/'.$p->id_pengumuman) ?>" class="btn btn-danger"><i class="fa fa-trash"></i> </a>
                            </td>
                        </tr>
