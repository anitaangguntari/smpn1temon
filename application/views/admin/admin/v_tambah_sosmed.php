          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                    ...
                    <?php echo form_open_multipart('admin/sosmed/tambah_aksi'); ?>
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group has-success">
                          ...
                          <input type="text" class="form-control" id="inputSuccess" name="link_sosmed">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <center>
                                  ...
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_sosmed">
                           <?php echo form_close() ?>
                            </center>
                         </div>
                    </div><!--  end row -->
