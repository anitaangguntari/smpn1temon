                ...
                <div class="panel-body">
                  <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <!-- <td><?php echo $no; ?></td> -->
                            <td><?php echo $v->isi_visi; ?></td>
                            <td><?php echo $v->isi_misi; ?></td>
                            <td>
                              <a href="<?php echo base_url('admin/visimisi/edit/'.$v->id_visimisi) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <!-- <a href="<?php echo base_url('admin/visimisi/delete/'.$v->id_visimisi) ?>" class="btn btn-danger"><i class="fa fa-pencil"></i> Hapus</a> -->
