          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                    <form role="form" action="<?php echo base_url('admin/ekstra/tambah_aksi') ; ?>" method="post">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Jenis Kegiatan</label>
                          <input type="text" class="form-control" id="inputSuccess" name="jenis_kegiatan">
                        </div>
                        <div class="form-group has-success">
                         ...
                         <div class="form-group has-success">
                          ...
                          <input type="time" class="form-control" id="inputSuccess" name="jam_mulai">
                        </div>
                         <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Jam Selesai</label>
                          <input type="time" class="form-control" id="inputSuccess" name="jam_selesai">
                        </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <center>
                                  ...
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_ekstra">
                            </form>
                            </center>
                         </div>
                    </div><!--  end row -->
