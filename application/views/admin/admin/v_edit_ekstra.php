        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              ...
              <a href="<?php echo base_url('admin/ekstra') ; ?>">Ekstrakurikuler</a>
            </li>
            <li class="breadcrumb-item active"><?php echo $ekstra['jenis_kegiatan']?></li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('admin/ekstra/update') ; ?>" method="post">
                    <div class="row">
                      <div class="col-md-6">
                         <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">Jenis Kegiatan</label>
                            <input type="text" class="form-control" id="inputSuccess" name="jenis_kegiatan" value="<?php echo $ekstra['jenis_kegiatan']?>">
                          </div>
                          <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">Hari</label>
                            <!-- <input type="text" class="form-control" id="inputSuccess" name="hari" value="<?php echo $ekstra['hari']?>"> -->
                            <select name="hari" required style="width:  100%;">
                              <option value="" disabled>Pilih</option>
                              <option value="Senin" <?php if($ekstra['hari'] == 'Senin'){ echo 'selected'; } ?>>Senin</option> 
                              <option value="Selasa" <?php if($ekstra['hari'] == 'Selasa'){ echo 'selected'; } ?>>Selasa</option>
                              <option value="Rabu" <?php if($ekstra['hari'] == 'Rabu'){ echo 'selected'; } ?>>Rabu</option>
                              <option value="Kamis" <?php if($ekstra['hari'] == 'Kamis'){ echo 'selected'; } ?>>Kamis</option>
                              <option value="Jumat" <?php if($ekstra['hari'] == 'Jumat'){ echo 'selected'; } ?>>Jum'at</option>
                              <option value="Sabtu" <?php if($ekstra['hari'] == 'Sabtu'){ echo 'selected'; } ?>>Sabtu</option>
                              <option value="Minggu" <?php if($ekstra['hari'] == 'Minggu'){ echo 'selected'; } ?>>Minggu</option>
                            </select>
                          </div>
                           <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">Jam Mulai</label>
                            <input type="time" class="form-control" id="inputSuccess" name="jam_mulai" value="<?php echo $ekstra['jam_mulai']?>">
                          </div>
                           <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">Jam Selesai</label>
                            <input type="time" class="form-control" id="inputSuccess" name="jam_selesai" value="<?php echo $ekstra['jam_selesai']?>">
                          </div>
                      </div>
                    </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <center>
                                  ...
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_ekstra" value="<?php echo $ekstra['id_ekstra']?>">
                            </form>
                            </center>
                         </div>
                    </div><!--  end row -->
