      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><?php echo $fasilitas['nama_fasilitas']?></li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('admin/fasilitas/update') ; ?>" enctype="multipart/form-data" method="post">
                   
                    <div class="row">
                       <div class="col-md-12">
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Nama</label>
                          <input name="nama_fasilitas" value="<?php echo $fasilitas['nama_fasilitas']?>" style="width: 50%;">
                        </div>
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Keterangan</label>
                          <textarea id="mytextarea" name="keterangan"><?php echo $fasilitas['keterangan']?></textarea>
                        </div>
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Gambar</label>
                          <img src="<?php echo base_url('images/'.$fasilitas['gambar']) ?>" width="100">
                        </div>
