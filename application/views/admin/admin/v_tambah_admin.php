          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                    <form role="form" action="<?php echo base_url('admin/admin/tambah_aksi') ; ?>" method="post">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Nama Admin</label>
                          <input type="text" class="form-control" id="inputSuccess" name="nama_admin">
                        </div>
                         <div class="form-group has-success">
                         ...
                         <div class="form-group has-success">
                          ...
                          <input type="text" class="form-control" id="inputSuccess" name="password">
                        </div>
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Jabatan</label>
                          <div class="radio">
                              <label>
                                <input type="radio" name="jabatan" id="optionsRadios1" value="Admin" checked />Admin
                              </label>
                          </div>
                          <div class="radio">
                              <label>
                                <input type="radio" name="jabatan" id="optionsRadios2" value="Guru"/>Guru
                              </label>
                          </div>
                          <div class="radio">
                              <label>
                                <input type="radio" name="jabatan" id="optionsRadios2" value="Osis"/>Osis
                              </label>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <center>
                                  ...
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_berita">
                            </form>
                            </center>
                         </div>
                    </div><!--  end row -->
