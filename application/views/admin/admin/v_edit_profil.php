      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><?php echo $profil['nama_sekolah']?></li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('admin/profil/update') ; ?>" enctype="multipart/form-data" method="post">
                   
                    <div class="row">
                       <div class="col-md-12">
                        <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">Nama Sekolah</label>
                            <input type="text" class="form-control" id="inputSuccess" name="nama_sekolah" value="<?php echo $profil['nama_sekolah']?>" style="width: 50%;">
                        </div>
                        <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">Alamat Sekolah</label>
                            <textarea type="text" class="form-control" id="inputSuccess" name="alamat_sekolah" ><?php echo $profil['alamat_sekolah']?></textarea> 
                        </div>
                        <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">No Telp. </label>
                            <input type="text" class="form-control" id="inputSuccess" name="no_telp" value="<?php echo $profil['no_telp']?>"  style="width: 50%;">
                        </div>
                        <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">Email </label>
                            <input type="text" class="form-control" id="inputSuccess" name="email" value="<?php echo $profil['email']?>"  style="width: 50%;">
                        </div>
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Isi Profil</label>
                          <textarea id="mytextarea" name="isi_profil"><?php echo $profil['isi_profil']?></textarea>
                        </div>
                         <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Sambutan Kepala Sekolah</label>
                          <textarea id="mytextarea1" name="isi_lainnya"><?php echo $profil['isi_lainnya']?></textarea>
                        </div>
                         <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Logo Sekolah</label>
                          <img src="<?php echo base_url('images/'.$profil['logo_sekolah']) ?>" width="100">
                        </div>
                        <input type="checkbox" name="ubah_foto" value="true"> Ceklis jika ingin mengubah foto<br>
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Ganti logo_sekolah</label>
                          <input type="file" name="logo_sekolah"></br>
