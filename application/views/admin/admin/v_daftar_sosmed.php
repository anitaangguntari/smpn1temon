        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3>Daftar Sosmed&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/sosmed/tambah') ; ?>"class="btn btn-info">+</a></h3>
            <div class="card-body">
                <div class="panel-body">
                  <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo $no; ?></td>
                            <td><img src='<?=base_url()?>images/<?=$s->logo_sosmed;?>' style="width: 50px;"></td>
                            <td><?php echo $s->link_sosmed; ?></td>

                            <td>
                              <a href="<?php echo base_url('admin/sosmed/edit/'.$s->id_sosmed) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('admin/sosmed/delete/'.$s->id_sosmed) ?>" class="btn btn-danger"><i class="fa fa-trash"></i> </a>
