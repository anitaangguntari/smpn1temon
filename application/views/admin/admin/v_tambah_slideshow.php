        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3>Tambah Slide Show</h3>
            <div class="card-body">
                <div class="panel-body">
                  <p><?php echo $this->session->flashdata('msg') ?></p>
                  <?php echo form_open_multipart('admin/slideshow/tambah_slideshow'); ?>
                    <div class="row">
                      <div class="col-md-6">                         
                        ...
                        <div class="form-group has-success">
                          ...
                          <input type="text" class="form-control" id="inputSuccess" name="judul_keterangan">
                        </div>
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Keterangan</label>
                          <input type="text" class="form-control" id="inputSuccess" name="keterangan">
                        </div>
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Deskripsi</label>
                          <input type="text" class="form-control" id="inputSuccess" name="deskripsi">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <center>
                                  <input type="hidden" name="id_slideshow"> 
