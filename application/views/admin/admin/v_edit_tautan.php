        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              ...
              <a href="<?php echo base_url('admin/tautan') ; ?>">Tautan</a>
            </li>
            <li class="breadcrumb-item active"><?php echo $tautan['judul_tautan']?></li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('admin/tautan/update') ; ?>"enctype="multipart/form-data" method="post">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Judul Tautan</label>
                          <input type="text" class="form-control" id="inputSuccess" name="judul_tautan" value="<?php echo $tautan['judul_tautan']?>">
                        </div>
                         <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Tujuan Tautan (URL)</label>
                          <input type="text" class="form-control" id="inputSuccess" name="tujuan_tautan" value="<?php echo $tautan['tujuan_tautan']?>">
                        </div>
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Logo</label>
                          <img src="<?php echo base_url('images/'.$tautan['logo']) ?>" width="100">
                        </div>
                        <input type="checkbox" name="ubah_foto" value="true"> Ceklis jika ingin mengubah logo<br>
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Ganti Logo</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <center>
                                  ...
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_tautan" value="<?php echo $tautan['id_tautan']?>">
                            </form>
                            </center>
                         </div>
                    </div><!--  end row -->
