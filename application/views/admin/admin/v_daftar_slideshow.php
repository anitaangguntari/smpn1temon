        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3>Daftar Slide Show&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/slideshow/tambah') ; ?>"class="btn btn-info">+</a></h3>
            <div class="card-body">
                <div class="panel-body">
                  <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo $no; ?></td>
                            <td><img src='<?=base_url()?>images/<?=$s->gambar;?>' style="width: 300px; height: 150px;"></td>
                            <td><?php echo $s->judul_keterangan; ?></td>
                            <td><?php echo $s->keterangan; ?></td>
                            <td><?php echo $s->deskripsi; ?></td>
                            <td>
                              <a href="<?php echo base_url('admin/slideshow/edit/'.$s->id_slideshow) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('admin/slideshow/delete/'.$s->id_slideshow) ?>" class="btn btn-danger"><i class="fa fa-trash"></i> </a>
                            </td>
                        </tr>
