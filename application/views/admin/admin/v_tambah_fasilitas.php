          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  ...
                  <?php echo form_open_multipart('admin/fasilitas/tambah_aksi'); ?>
                      ...
                      <div class="col-md-12">
                        <table align="" style="width: 100%;">
                          <tr>
                            ...
                            <td></td>
                            <td><input type="text" class="form-control" id="inputSuccess" name="nama_fasilitas"></td>
                          </tr>
                          <tr>
                            <td>Keterangan</td>
                            <td></td>
                            <td><textarea id="mytextarea" name="keterangan" style="width: 100%;" ></textarea></td>
                          </tr>
                           <tr>
                            <td>Gambar</td>
                            <td></td>
                            <td><input type="file" name="gambar"></br></td>
                            <td>  <font color="red" >(File bertipe jpg/png/gif dengan ukuran maksimal 2 MB)</font></td>
                          </tr>
                          </table>
                      </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <center>
                                  ...
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_fasilitas">
                            <!-- </form> -->
                            </center>
                         </div>
                      <?php echo form_close() ?>
