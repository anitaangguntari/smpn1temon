        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              ...
              <a href="<?php echo base_url('admin/sejarah') ; ?>">Sejarah</a>
            </li>
            <li class="breadcrumb-item active"><?php echo $sejarah['id_sejarah']?></li>
          </ol>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3>Edit Sejarah</h3>
            <div class="card-body" style="box-shadow: 1px 1px 3px #122e33; background-color: white; padding-left: 10px; padding-top: 10px; padding-right: 10px; margin-top: 0px;">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('admin/sejarah/update') ; ?>" enctype="multipart/form-data" method="post">
                   
                    <div class="row">
                       <div class="col-md-12">
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Isi Sejarah</label>
                          <textarea id="mytextarea" name="isi_sejarah"><?php echo $sejarah['isi_sejarah']?></textarea>
                        </div>
                         <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Gambar</label>
                          <img src="<?php echo base_url('images/'.$sejarah['gambar']) ?>" width="500">
                        </div>
                        <input type="checkbox" name="ubah_foto" value="true"> Ceklis jika ingin mengubah foto<br>
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Ganti Gambar</label>
                          <input type="file" name="gambar"></br>
                          <font color="red" >(File bertipe jpg/png/gif dengan ukuran <= 3 MB)</font>
                        </div>
                      </div>
                    </div>
                    <div class="row">
