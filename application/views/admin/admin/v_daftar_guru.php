        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3>Daftar Guru &nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/guru/tambah') ; ?>"class="btn btn-info">+</a></h3>
            <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        <?php 
                            $no=0;
                        ?>
                        <?php foreach( $guru as $g ) : ?> <!-- Mulai loop -->
                        <?php 
                            $no++;
                        ?>
                        <?php $tanggal = $g->tgl_lahir_guru;
                        ...
                        <tr>
                            ...
                            <td><?php echo $g->jk_guru; ?></td>
                            <td><?php echo $g->no_telp_guru; ?></td>
                            <td><?php echo $g->jabatan; ?></td>
                            <td><?php echo $g->jenis_guru; ?></td>
                            <td><img src='<?=base_url()?>images/<?=$g->foto_guru;?>'></td>
                            <td>
                              <a href="<?php echo base_url('admin/guru/edit/'.$g->guru_id) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('admin/guru/delete/'.$g->guru_id) ?>" class="btn btn-danger"><i class="fa fa-trash"></i> </a>
                            </td>
                        </tr>
