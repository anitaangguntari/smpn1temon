        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              ...
              <a href="<?php echo base_url('admin/sosmed') ; ?>">Sosmed</a>
            </li>
            <li class="breadcrumb-item active"><?php echo $sosmed['link_sosmed']?></li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('admin/sosmed/update') ; ?>"enctype="multipart/form-data" method="post">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Logo</label>
                          <img src="<?php echo base_url('images/'.$sosmed['logo_sosmed']) ?>" width="100">
                        </div>
                        ...
                        <div class="form-group has-success">
                          ...
                          <input type="file" name="logo_sosmed"></br>
                         ...
                         <div class="form-group has-success">
                          ...
                          <input type="text" class="form-control" id="inputSuccess" name="link_sosmed" value="<?php echo $sosmed['link_sosmed']?>">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <center>
                                  ...
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_sosmed" value="<?php echo $sosmed['id_sosmed']?>">
                            </form>
                            </center>
                         </div>
                    </div><!--  end row -->
