        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3>Daftar Fasilitas&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/fasilitas/tambah') ; ?>"class="btn btn-info">+</a></h3>
            <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src='<?=base_url()?>images/<?=$f->gambar;?>' style="width: 500px; height: 300px;"></td>

                            <td>
                              <a href="<?php echo base_url('admin/fasilitas/edit/'.$f->id_fasilitas) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('admin/fasilitas/delete/'.$f->id_fasilitas) ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> </a>
