        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3>Daftar Artikel &nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/artikel/tambah') ; ?>"class="btn btn-info">+</a></h3>
            <div class="card-body">
                <div class="panel-body">
                  <div class="table-responsive">
                    <div class="tambah" align="center"> 
                      <!-- <a href="<?php echo base_url('admin/berita/tambah_berita') ?>" class="btn btn-success">Tambah Data</a> -->
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo substr($a->isi_artikel ,0 ,500); ?></td>
                            <td><img src='<?=base_url()?>images/<?=$a->gambar;?>' style="width: 100px; height: 100px;"></td>
                            <td>
                              <a href="<?php echo base_url('admin/artikel/edit/'.$a->id_artikel) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('admin/artikel/delete/'.$a->id_artikel) ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> </a>
                                <!-- <a onclick="deleteConfirm('<?php echo base_url('berita/delete/'.$a->id_berita) ?>')"
                               href="<?php echo base_url('berita/delete/'.$a->id_berita) ?>" class="btn btn-danger"><i class="fa fa-pencil"></i> Hapus</a> -->
                            </td>
                        </tr>
