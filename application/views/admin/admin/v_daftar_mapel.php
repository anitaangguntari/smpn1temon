        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3>Daftar Mata Pelajaran&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/mapel/tambah') ; ?>"class="btn btn-info">+</a></h3>
            <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        <?php 
                            $no=0;
                        ?>
                        <?php foreach( $mapel as $m ) : ?> <!-- Mulai loop -->
                        <?php 
                            $no++;
                        ?>
                        <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url('admin/mapel/edit/'.$m->id_mapel) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('admin/mapel/delete/'.$m->id_mapel) ?>" class="btn btn-danger"><i class="fa fa-trash"></i> </a>
