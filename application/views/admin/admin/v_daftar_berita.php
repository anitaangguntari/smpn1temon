        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3>Daftar Berita &nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/berita/tambah') ; ?>"class="btn btn-info">+</a></h3>
            <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src='<?=base_url()?>images/<?=$b->gambar;?>'></td>
                            <td>
                              <a href="<?php echo base_url('admin/berita/edit/'.$b->id_berita) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('admin/berita/delete/'.$b->id_berita) ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> </a>
                                <!-- <a onclick="deleteConfirm('<?php echo base_url('berita/delete/'.$b->id_berita) ?>')"
                               href="<?php echo base_url('berita/delete/'.$b->id_berita) ?>" class="btn btn-danger"><i class="fa fa-pencil"></i> Hapus</a> -->
                            </td>
                        </tr>
