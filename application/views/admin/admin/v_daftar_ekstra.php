        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h2 style="color: green;">Daftar Ekstrakurikuler</h2>&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/ekstra/tambah') ; ?>"class="btn btn-info">+</a></br>
                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        <?php 
                            $no=0;
                        ?>
                        <?php foreach( $ekstra as $e ) : ?> <!-- Mulai loop -->
                        <?php 
                            $no++;
                        ?>
                        <tr>
                            <td><?php echo $no; ?></td>
                            <td><?php echo $e->jenis_kegiatan; ?></td>
                            <td><?php echo $e->hari; ?></td>
                            <td><?php echo $e->jam_mulai; ?> s/d <?php echo $e->jam_selesai; ?></td>
                            <td>
                              <a href="<?php echo base_url('admin/ekstra/edit/'.$e->id_ekstra) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('admin/ekstra/delete/'.$e->id_ekstra) ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> </a>
