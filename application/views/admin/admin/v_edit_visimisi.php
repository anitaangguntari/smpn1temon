        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              ...
              <a href="<?php echo base_url('admin/visimisi') ; ?>">Visi Misi</a>
            </li>
            <li class="breadcrumb-item active"><?php echo $visimisi['id_visimisi']?></li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('admin/visimisi/update') ; ?>" enctype="multipart/form-data" method="post">
                   
                    <div class="row">
                       <div class="col-md-12">
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Isi Visi</label>
                          <textarea id="mytextarea" name="isi_visi" style="width: 100%;"><?php echo $visimisi['isi_visi']?></textarea>
                        </div>
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Isi Misi</label>
                          <textarea id="mytextarea1" name="isi_misi" style="width: 100%;"><?php echo $visimisi['isi_misi']?></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <center>
                               ...
                               <input type="hidden" name="id_visimisi" value="<?php echo $visimisi['id_visimisi'] ;?>">
                              </form>
                            </center>
                         </div>
                      <!-- <?php echo form_close() ?> -->
