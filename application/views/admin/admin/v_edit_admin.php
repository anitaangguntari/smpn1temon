      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><?php echo $admin['nama_admin']?></li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('admin/admin/update') ; ?>" method="post">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Nama Admin</label>
                          <input type="text" class="form-control" id="inputSuccess" name="nama_admin" value="<?php echo $admin['nama_admin']?>">
                        </div>
                         <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Username</label>
                          <input type="text" class="form-control" id="inputSuccess" name="username" value="<?php echo $admin['username']?>">
                        </div>
                         <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Password</label>
                          <input type="password" class="form-control" id="inputSuccess" name="password" value="<?php echo $admin['password']?>">
                        </div>
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Jabatan</label>
                          <div class="radio">
                              <label>
                                <input type="radio" name="jabatan" id="optionsRadios1" value="Admin"  <?php if($admin['jabatan']=='Admin'){echo "checked";}?>/>Admin
                              </label>
                          </div>
                          <div class="radio">
                              <label>
                                <input type="radio" name="jabatan" id="optionsRadios2" value="Guru" <?php if($admin['jabatan']=='Guru'){echo "checked";}?>/>Guru
                              </label>
                          </div>
                          <div class="radio">
                              <label>
                                <input type="radio" name="jabatan" id="optionsRadios2" value="Guru" <?php if($admin['jabatan']=='Osis'){echo "checked";}?>/>Osis
                              </label>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <center>
                                  ...
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_admin" value="<?php echo $admin['id_admin']?>">
                            </form>
                            </center>
                         </div>
                    </div><!--  end row -->
