          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('admin/jadwal/update') ; ?>" method="post">
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group has-success">
                          ...
                          <img src="<?php echo base_url('images/'.$jadwal['gambar_jadwal']) ?>" width="500">
                        </div>
                        <input type="checkbox" name="ubah" value="true"> Ceklis jika ingin mengubah logo<br>
                        <div class="form-group has-success">
