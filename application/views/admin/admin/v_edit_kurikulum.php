      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><?php echo $kurikulum['id_kurikulum']?></li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('admin/kurikulum/update') ; ?>" enctype="multipart/form-data" method="post">
                   
                    <div class="row">
                       <div class="col-md-12">
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Isi Kurikulum</label>
                          <textarea id="mytextarea" name="isi_kurikulum"><?php echo $kurikulum['isi_kurikulum']?></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <center>
                               ...
                               <input type="hidden" name="id_kurikulum" value="<?php echo $kurikulum['id_kurikulum'] ;?>">
                              </form>
                            </center>
                         </div>
                      <!-- <?php echo form_close() ?> -->
