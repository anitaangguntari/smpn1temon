          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                    <!-- <form role="form" action="<?php echo base_url('admin/tautan/tambah_aksi') ; ?>" method="post"> -->
                    <?php echo form_open_multipart('admin/tautan/tambah_aksi'); ?>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Judul Tautan</label>
                          <input type="text" class="form-control" id="inputSuccess" name="judul_tautan">
                        </div>
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Tujuan Tautan (URL)</label>
                          <input type="text" class="form-control" id="inputSuccess" name="tujuan_tautan">
                        </div>
                        <div class="form-group has-success">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <center>
                                  ...
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_tautan">
                           <?php echo form_close() ?>
                            </center>
                         </div>
                    </div><!--  end row -->
