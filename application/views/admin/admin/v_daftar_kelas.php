        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3>Daftar Kelas &nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/kelas/tambah') ; ?>"class="btn btn-info">+</a></h3>
            <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        <?php 
                            $no=0;
                        ?>
                        <?php foreach( $kelas as $k ) : ?> <!-- Mulai loop -->
                        <?php 
                            $no++;
                        ?>
                        <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url('admin/kelas/edit/'.$k->id_kelas) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('admin/kelas/delete/'.$k->id_kelas) ?>" class="btn btn-danger"><i class="fa fa-trash"></i> </a>
