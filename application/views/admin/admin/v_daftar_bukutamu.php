                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        <?php 
                            $no=0;
                        ?>
                        <?php foreach( $bukutamu as $b ) : ?> <!-- Mulai loop -->
                        <?php 
                            $no++;
                        ?>
                        <tr>
                            <td><?php echo $no; ?></td>
                            <td><?php echo $b->nama_tamu; ?></td>
                            <td><?php echo $b->email; ?></td>
                            <td><?php echo $b->no_telp; ?></td>
                            <td><?php echo $b->saran; ?></td>
                            <!-- <td>
                              <a href="<?php echo base_url('admin/admin/edit/'.$b->id_admin) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('admin/admin/delete/'.$b->id_admin) ?>" class="btn btn-danger"><i class="fa fa-pencil"></i> </a>
