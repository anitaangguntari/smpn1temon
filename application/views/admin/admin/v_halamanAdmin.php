        ...
        <div class="container-fluid">
         ...
         <!--  <ol class="breadcrumb">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <img src="<?php echo base_url('images/'.$banner['banner']) ?>" style="width: 100%; height: 600px;">
                <form role="form" action="<?php echo base_url('admin/banner/update') ; ?>" enctype="multipart/form-data" method="post">
                  ...
                  <div class="form-group has-success">
                   ...
                   <button type="submit" class="btn btn-info">Simpan<i class="icon-check position-right"></i></button>
                </form>
            <!-- <b> -->
              <!-- <p style="margin-top: 1%; text-align: center; text-shadow: 5px 5px 0px #D7DACC; color: purple; font-size: 45px;" class="w3-animate-top" style="width:100%">SEKOLAH MENENGAH PERTAMA</p>
              <p style="margin-top: 2%; text-align: center; text-shadow: 5px 5px 0px #D7DACC; color: purple; font-size: 60px;" class="w3-animate-zoom" style="width:100%">NEGERI</p> -->
              <!-- <h1 style="margin-top: 3%; text-align: center; text-shadow: 5px 5px 0px #D7DACC; color: purple;" class="w3-animate-left" style="width:100%">1</h1> -->
             <!--  <p style="margin-top: 3%; text-align: center; text-shadow: 5px 5px 0px #D7DACC; color: purple; font-size: 45px;" class="w3-animate-bottom" style="width:100%">1 TEMON</p> -->
            <!-- </b> -->
            </div>
