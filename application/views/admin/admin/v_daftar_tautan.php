      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Tautan</li>
          </ol>

          <!-- DataTables Example -->
          <div class="card mb-3">
            <div class="card-header">
              <h3>Daftar Tautan&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/tautan/tambah') ; ?>"class="btn btn-info">+</a></h3>
            <div class="card-body">
                <div class="panel-body">
                  <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo $no; ?></td>
                            <td><?php echo $t->judul_tautan; ?></td>
                            <td><?php echo $t->tujuan_tautan; ?></td>
                            <td><img src='<?=base_url()?>images/<?=$t->logo;?>' style="width: 50px;"></td>

                            <td>
                              <a href="<?php echo base_url('admin/tautan/edit/'.$t->id_tautan) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('admin/tautan/delete/'.$t->id_tautan) ?>" class="btn btn-danger"><i class="fa fa-trash"></i> </a>
