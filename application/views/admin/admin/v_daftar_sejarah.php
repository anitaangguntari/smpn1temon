                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src='<?=base_url()?>images/<?=$s->gambar;?>'></td>
                            <td>
                              <a href="<?php echo base_url('admin/sejarah/edit/'.$s->id_sejarah) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <!-- <a href="<?php echo base_url('admin/sejarah/delete/'.$s->id_sejarah) ?>" class="btn btn-danger"><i class="fa fa-pencil"></i> </a> -->
                            </td>
                        </tr>
