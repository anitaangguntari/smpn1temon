                ...
                <div class="panel-body">
                  <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <!-- <td><?php echo $no; ?></td> -->
                            <td><?php echo $k->isi_kurikulum; ?></td>
                            <td>
                              <a href="<?php echo base_url('admin/kurikulum/edit/'.$k->id_kurikulum) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <!-- <a href="<?php echo base_url('admin/mapel/delete/'.$k->id_mapel) ?>" class="btn btn-danger"><i class="fa fa-pencil"></i> </a> -->
