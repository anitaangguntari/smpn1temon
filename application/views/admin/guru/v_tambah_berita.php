        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              ...
              <a href="<?php echo base_url('gru/berita') ; ?>">Berita</a>
            </li>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  ...
                  <?php echo form_open_multipart('gru/berita/tambah_berita'); ?>
                        ...
                        <table align="" style="width: 100%;">
                          <tr>
                            ...
                            <td><input type="text" name="tanggal" value="<?php echo date('d-m-Y'); ?>" disabled></td>
                             <input type="hidden" class="form-control" id="inputSuccess" name="tanggal" value="<?php echo date('d-m-Y'); ?>">
                          </tr>
                          <tr>
                            <td>Judul Berita</td>
                            <td></td>
                            <td><textarea name="judul_berita" style="width: 100%;"></textarea></td>
                          </tr>
                          <tr>
                            <td>Isi Berita</td>
                            <td></td>
                            <td><textarea id="mytextarea" name="isi_berita" ></textarea></td>
                          </tr>
                          <tr>
                            <td>Gambar</td>
                            <td></td>
