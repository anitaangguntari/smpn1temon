        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3>Daftar Agenda&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('gru/agenda/tambah') ; ?>"class="btn btn-info">+</a></h3>
            <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url('gru/agenda/edit/'.$a->id_agenda) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('gru/agenda/delete/'.$a->id_agenda) ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> </a>
