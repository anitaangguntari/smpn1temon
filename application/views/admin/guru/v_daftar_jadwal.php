        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h2 style="color: green;">Daftar Jadwal Mata Pelajaran&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('gru/jadwal/tambah') ; ?>"class="btn btn-info">+</a></h2></br>
            <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url('gru/jadwal/edit/'.$j->id_jadwal) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('gru/jadwal/delete/'.$j->id_jadwal) ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> </a>
