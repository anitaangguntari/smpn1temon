        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3>Daftar Berita &nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('gru/berita/tambah') ; ?>"class="btn btn-info">+</a></h3>
            <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url('gru/berita/edit/'.$b->id_berita) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('gru/berita/delete/'.$b->id_berita) ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> </a>
