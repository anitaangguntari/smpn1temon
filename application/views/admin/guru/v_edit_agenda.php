        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              ...
              <a href="<?php echo base_url('gru/agenda') ; ?>">Agenda</a>
            </li>
            <li class="breadcrumb-item active"><?php echo $agenda['judul_agenda']?></li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('gru/agenda/update') ; ?>" method="post">
                    <div class="row">
                      <div class="col-md-6">
                          <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">Tanggal</label>
                            <input type="text" class="form-control" id="inputSuccess" name="tanggal_agenda" value="<?php echo $agenda['tanggal_agenda']?>">
                          </div>
                          <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">Judul Agenda</label>
                            <input type="text" class="form-control" id="inputSuccess" name="judul_agenda" value="<?php echo $agenda['judul_agenda']?>">
                          </div>
                          <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">Keterangan Agenda</label>
                            <textarea class="textarea" name="keterangan_agenda"><?php echo $agenda['keterangan_agenda']?></textarea>
                          </div>
                          <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">Gambar</label>
                            <img src="<?php echo base_url('images/'.$agenda['gambar']) ?>" width="100">
                          </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <center>
                                  ...
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_agenda" value="<?php echo $agenda['id_agenda']?>">
                            </form>
                            </center>
                         </div>
                    </div><!--  end row -->
