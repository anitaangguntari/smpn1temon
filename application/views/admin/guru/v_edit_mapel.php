        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              ...
              <a href="<?php echo base_url('gru/mapel') ; ?>">Mata Pelajaran</a>
            </li>
            <li class="breadcrumb-item active"><?php echo $varmapel->nama_mapel?></li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('gru/mapel/update') ; ?>" method="post">
                    <div class="row">
                      <div class="col-md-6">
                          <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">Nama Mapel</label>
                            <input type="text" class="form-control" id="inputSuccess" name="nama_mapel" value="<?php echo $varmapel->nama_mapel?>">
                          </div>
                           <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">Guru</label>
                             <select name="nip" class="form-control" >
                             <?php 
                              foreach($listguru as $vguru) {
                                if ($vguru['nip'] == $varmapel->nip) {
                                  echo '<option value="'.$vguru->nip.'" selected>'.$vguru['nama_guru'].'</option>';
                                } else {
                                  echo '<option value="'.$vguru['nip'].'">'.$vguru['nama_guru'].'</option>';
                                }
                              }
                              ?>
                            </select>
                          ...
                          <div class="form-group has-success">
                            ...
                            <select class="form-control" disabled="disabled">
                             <?php 
                              foreach($listkelas as $vkelas) {
                                if ($vkelas['id_kelas'] == $varmapel->kelas) {
                                  echo '<option value="'.$vkelas->id_kelas.'" selected>'.$vkelas['nama_kelas'].' </option>';
                                } else {
                                  echo '<option value="'.$vkelas['id_kelas'].'">'.$vkelas['nama_kelas'].'</option>';
                                }
                              }
                              ?>
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <center>
                                  ...
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_mapel" value="<?php echo $varmapel->id_mapel?>">
                                   <input type="hidden" class="form-control" id="inputSuccess" name="kelas" value="<?php echo $varmapel->kelas?>">
                            </form>
                            </center>
                         </div>
                    </div><!--  end row -->
