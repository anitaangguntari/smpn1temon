      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><?php echo $artikel['judul_artikel']?></li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('gru/artikel/update') ; ?>"enctype="multipart/form-data" method="post">
                    <?php $tanggal = $artikel['tanggal_artikel'];
                      ...
                      <div class="col-md-12">
                        <table align="" style="width: 100%;">
                          <tr>
                            ...
                            <td></td>
                            <td><input type="text" name="tanggal_artikel" value="<?php echo $tgl ?>" disabled></td>
                          </tr>
                          <tr>
                            <td>Judul Artikel</td>
                            <td></td>
                            <td><textarea name="judul_artikel" style="width: 100%;"><?php echo $artikel['judul_artikel'] ?></textarea></td>
                          </tr>
                          <tr>
                            <td>Isi Artikel</td>
                            <td></td>
                            <td><textarea id="mytextarea" name="isi_artikel"><?php echo $artikel['isi_artikel']?></textarea></td>
                          </tr>
                          <tr>
                            <td>Gambar</td>
                            <td></td>
                            <td> <img src="<?php echo base_url('images/'.$artikel['gambar']) ?>" width="500"></td>
                          </tr></br></br>
                         <!--  <tr>
