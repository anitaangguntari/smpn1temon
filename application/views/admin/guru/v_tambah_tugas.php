        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              ...
              <a href="<?php echo base_url('gru/penugasan') ; ?>">Penugasan</a>
            </li>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                    <?php echo form_open_multipart('admin/penugasan/tambah_aksi'); ?>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group has-success">
                         ...
                         <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Guru</label></br>
                          <select class="form-control"  id="inputSuccess" name="guru_id">
                            <option value='' disabled selected>Pilih</option>
                              <?php 
                                foreach ($guru as $g) {  
                                  echo "<option value='".$g->guru_id."'>".$g->nama_guru."</option>";
                                }
                              ?>
                          </select>
                        </div>
                         <div class="form-group has-success">
                          ...
                          <select class="form-control"  id="inputSuccess" name="id_mapel">
                            <option value='' disabled selected>Pilih</option>
                              <?php 
                                foreach ($mapel as $m) {  
                        ...
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Isi Tugas</label></br>
                          <input type="file" name="isi_tugas"></br>
                        ...
                        <div class="form-group has-success">
                          ...
                          <textarea name="ket_tugas" style="width: 100%;"></textarea>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <center>
                                  ...
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_tugas">
                           <?php echo form_close() ?>
                            </center>
                         </div>
                    </div><!--  end row -->
