        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3>Daftar Mata Pelajaran&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('gru/mapel/tambah') ; ?>"class="btn btn-info">+</a></h3>
            <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url('gru/mapel/edit/'.$m->id_mapel) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('gru/mapel/delete/'.$m->id_mapel) ?>" class="btn btn-danger"><i class="fa fa-trash"></i> </a>
