        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              ...
              <a href="<?php echo base_url('gru/kelas') ; ?>">Kelas</a>
            </li>
            <li class="breadcrumb-item active"><?php echo $varkelas->nama_kelas?></li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('gru/kelas/update') ; ?>" method="post">
                    <div class="row">
                      <div class="col-md-6">
                          <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">Nama Kelas</label>
                            <input type="text" class="form-control" id="inputSuccess" name="nama_kelas" value="<?php echo $varkelas->nama_kelas?>">
                          </div>
                           <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">Wali Kelas</label>
                              <select name="nip" class="form-control" >
                             <?php 
                              foreach($listguru as $vguru) {
                                if ($vguru['nip'] == $varkelas->nip) {
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <center>
                                  ...
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_kelas" value="<?php echo $varkelas->id_kelas?>">
                            </form>
                            </center>
                         </div>
                    </div><!--  end row -->
