        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              ...
              <a href="<?php echo base_url('gru/pengumuman') ; ?>">Pengumuman</a>
            </li>
            <li class="breadcrumb-item active"><?php echo $pengumuman['id_pengumuman'] ?></li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('gru/pengumuman/update') ; ?>" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                       <div class="col-md-6">
                        ...
                        <div class="form-group has-success">
                          ...
                          <img src="<?php echo base_url('images/'.$pengumuman['gambar']) ?>" width="100" name="gambar">
                        </div>
                        ...
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Isi Pengumuman</label>
                          <textarea class="ckeditor" name="isi_pengumuman" ><?php echo $pengumuman['isi_pengumuman'] ?></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="row">
