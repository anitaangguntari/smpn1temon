        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              ...
              <a href="<?php echo base_url('gru/artikel') ; ?>">Artikel</a>
            </li>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  ...
                  <?php echo form_open_multipart('gru/artikel/tambah_artikel'); ?>
                    <!-- <form role="form" action="<?php echo base_url('berita/tambah_berita') ; ?>" method="post"> -->
                    <div class="row">
                      <div class="col-md-12">
                        <table align="" style="width: 100%;">
                          <tr>
                            ...
                            <td></td>
                            <td><input type="text" name="tanggal_artikel" value="<?php echo date('d-m-Y'); ?>" disabled></td>
                             <input type="hidden" class="form-control" id="inputSuccess" name="tanggal_artikel" value="<?php echo date('d-m-Y'); ?>">
                          </tr>
                          <tr>
                            <td>Judul Artikel</td>
                            <td></td>
                            <td><textarea name="judul_artikel" style="width: 100%;"></textarea></td>
                          </tr>
                          <tr>
                            <td>Isi Artikel</td>
                            <td></td>
                            <td><textarea id="mytextarea" name="isi_artikel" ></textarea></td>
                          </tr>
                          <tr>
                            <td>Gambar</td>
                            <td></td>
                            <td><input class="form-control-file <?php echo form_error('image') ? 'is-invalid':'' ?>" type="file" name="gambar" />
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <center>
                                  ...
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_artikel">
                            <!-- </form> -->
                            </center>
                         </div>
                      <?php echo form_close() ?>
