        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h2 style="color: green;">Daftar Penugasan Mata Pelajaran&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/penugasan/tambah') ; ?>"class="btn btn-info">+</a></h2></br>
            <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src='<?=base_url()?>images/<?=$t->isi_tugas;?>' style="width: 300px; height: auto;"></td>
                            <td><?php echo $t->ket_tugas; ?></td>
                            <td>
                              <a href="<?php echo base_url('admin/penugasan/edit/'.$t->id_tugas) ?>"
                               class="btn btn-success"><i class="fa fa-edit"></i> </a>
                              <a href="<?php echo base_url('admin/penugasan/delete/'.$t->id_tugas) ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> </a>
