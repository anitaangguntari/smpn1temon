          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                    <form role="form" action="<?php echo base_url('gru/kelas/tambah_aksi') ; ?>" method="post">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Nama Kelas</label>
                          <input type="text" class="form-control" id="inputSuccess" name="nama_kelas">
                        </div>
                         <div class="form-group has-success">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <center>
                                  ...
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_kelas">
                            </form>
                            </center>
                         </div>
                    </div><!--  end row -->
