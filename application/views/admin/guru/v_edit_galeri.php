        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              ...
              <a href="<?php echo base_url('gru/galeri') ; ?>">Galeri</a>
            </li>
            <li class="breadcrumb-item active"><?php echo $galeri['judul_galeri']?></li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="panel-body">
                  <form role="form" action="<?php echo base_url('gru/galeri/update') ; ?>" enctype="multipart/form-data" method="post">
                   
                    <div class="row">
                       <div class="col-md-6">
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Judul Galeri</label>
                          <input type="text" class="form-control" id="inputSuccess" name="judul_galeri" value="<?php echo $galeri['judul_galeri'] ?>">
                        </div>
                        <div class="form-group has-success">
                          <label class="control-label" for="inputSuccess">Foto</label>
                          <img src="<?php echo base_url('images/'.$galeri['foto_galeri']) ?>" width="100">
                        </div>
