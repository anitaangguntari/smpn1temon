        ...
        <div class="container services">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item"  style="">
                     <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri;">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp; <a href="<?php echo base_url('artikel') ; ?>" style="color: black; font-family: calibri;">Artikel</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;"><?php echo $a['judul_artikel'] ?></font></br></br>
                    <h3 style="font-family: Calibri;"><?php echo $a['judul_artikel'] ?></h3></br>
                    ...
                    <div class="berita">
                        <center>
                            <img src="<?php echo base_url('images/'.$a['gambar']) ?>" style="width: 80%; height: 80%;">
                        </center></br></br>
                ...
                <!-- <div class='clear'/> -->
                    ...
                    <center>
                    <form action="<?php echo base_url('admin/rating/tambah_aksi_rat') ; ?>" method="post">
                        <div class="container">
                          ...
                          <input type="hidden" name="id_artikel" value="<?php echo $a['id_artikel'] ?>">
                    ...
                    <?php // echo json_encode($rating); ?>
                     <?php foreach( $reting as $r ) : ?> <!-- Mulai loop -->
                     <div style="background-color: white; padding-left: 10px;">
                        <p>Pengguna : &nbsp;<?php echo $r->email ?>&nbsp;&nbsp;&nbsp; </p>
                        <b>Nilai : (<?=$r->rating;?>)</b>
...
<!-- 
                        <div class="container">
                            <div class="starrating risingstar d-flex justify-content-center flex-row-reverse">
                                <input type="radio" id="star5" name="rating" value="5" <?php echo $teks_ceked_5; ?> /><label for="star5" title="5 star">5</label>
                                <input type="radio" id="star4" name="rating" value="4" <?php echo $teks_ceked_4; ?> /><label for="star4" title="4 star">4</label>
                                <input type="radio" id="star3" name="rating" value="3" <?php echo $teks_ceked_3; ?> /><label for="star3" title="3 star">3</label>
                                <input type="radio" id="star2" name="rating" value="2" <?php echo $teks_ceked_2; ?> /><label for="star2" title="2 star">2</label>
                                <input type="radio" id="star1" name="rating" value="1" <?php echo $teks_ceked_1; ?> /><label for="star1" title="1 star">1</label>
                            </div>
                        </div> -->
                           <?php
                        $rate = intval($r->rating);
                    ...
                    <?php endforeach; ?> <!-- Selesai loop -->
                    <form action="<?php echo base_url('artikel/tampil_rating') ; ?>" method="post">
                          <input type="hidden" name="id_artikel" value="<?php echo $a['id_artikel'] ?>">
                 ...
                 <div class="col-lg-4 col-sm-4 service-item" style="margin-top: 100px;">
