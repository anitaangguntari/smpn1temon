        ...
        <div class="container services" style="padding-top: 0px;">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item"  > 
                     <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri; ">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;">Guru</font></br></br>
                    <h3 style="font-family: Calibri;"><b>Daftar Guru</b></h3>
                    <p>Standar dan harapan profesional</p>
                    <section class="team-section spad">
                        <div class="container" style="width: 100%;">
                            ...
                            <div class="row">
                                 <?php foreach($data->result() as $g ) : ?> <!-- Mulai loop -->
                                <div class="col-md-6 col-lg-4" style="margin-bottom: 30px;">
                                    <div class="member">
                                        <div class="member-pic set-bg" data-setbg="<?=base_url()?>images/<?=$g->foto_guru;?>">
                                        ...
                                        <b>
                                            <h5 style=" font-family: calibri;"><?php echo $g->nama_guru; ?></h5>
                                            <p style="color: #f58e5c; text-align: center;"><?php echo $g->jabatan; ?></p>
                                            <!-- <p style=" color:black; font-size: 15px; text-align: center;"><?php echo $g->alamat_guru; ?></p> -->
                                        </b>
                                    </div>
                                </div>
                                <?php endforeach; ?> <!-- Selesai loop -->
                ...
                <div class="col-lg-4 col-sm-4 service-item" style="margin-top: 107px;">
                    ...
                    <!-- <form class="navbar-form navbar-left" action="<?= site_url("cari")?>" method="get">
                     ...
                     <!-- Search form (start) -->
                    <center>
                         <!-- <form method='post' action="<?= base_url('cari/loadRecord') ?>" >
                    ...
                    echo form_open("cari/search", $attr);?>
                        <div class="form-group">
                            <div class="col-md-6">
                                <input class="form-control" id="book_name" name="book_name" placeholder="Cari..." type="text" value="<?php echo set_value('book_name'); ?>"/>
                            </div>
                            <div class="col-md-6">
                                <input id="btn_search" name="btn_search" type="submit" class="btn btn-danger" value="Cari" style="" />
                                <a href="<?php echo base_url(). "guru"; ?>" class="btn btn-primary">Show All</a>
                            </div>
                        </div>
                    <?php echo form_close(); ?> -->
                    </center>
