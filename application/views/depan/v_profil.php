        ...
        <div class="container services">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item" style="box-shadow: 0px 0px 0px #122e33;">
                     <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri;">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;">Profil</font></br></br>
                    <h3 style="font-family: Calibri; color: #000;"><b>Tentang Kami</b></h3></br>
                    <div class="visi">
                        <?php foreach( $profil as $p ) : ?> <!-- Mulai loop -->
                            <!-- <center><img src='<?=base_url()?>images/<?=$p->logo_sekolah;?>' style="width: 50%;"></center></br></br> -->
                            <p>
                                <?php echo $p->isi_profil; ?>
                            </p>
                        <?php endforeach; ?> <!-- Selesai loop -->
