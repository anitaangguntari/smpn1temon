        ...
        <div class="container services">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item" > 
                     <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri;">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;">Galeri</font></br></br>
                    <h3 style="font-family: Calibri;"><b>Galeri Foto</b></h3>
                    <div class="row">
                        <?php foreach( $data->result() as $g ) : ?> <!-- Mulai loop -->
                           <div class="col-sm-12 col-md-4 col-lg-4">
                                <div class="zoom-effect">
                                    <div class="course-thumb"></br>
                                        <img src='<?=base_url()?>images/<?=$g->foto_galeri;?>' height="250"style="box-shadow: 5px 5px 10px #122e33;">
                                    </div>
                                </div>
                                </br>
                                <p align="center" style="font-family: Calibri;"><?php echo $g->judul_galeri; ?></p>
                           </div>
                        <?php endforeach; ?> <!-- Selesai loop -->
                    </div></br>
                     <div class="row">
