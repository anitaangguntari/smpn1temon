        ...
        <div class="container services">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item" > 
                    <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri;">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;">Ekstrakurikuler</font></br></br>
                    <h3 style="font-family: Calibri; color: #000;"><b>Ekstrakurikuler</b></h3></br>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
                                         <thead>
                                            <tr style="box-shadow: 0px 0px 0px #400404; text-align: center;">
                                                ...
                                                <th style="box-shadow: 0px 0px 0px #400404;">Jenis Kegiatan</th>
                                                <th style="box-shadow: 0px 0px 0px #400404;">Hari</th>
                                                <th style="box-shadow: 0px 0px 0px #400404;">Waktu</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php 
                                                $no=0;
                                            ?> 
                                            <?php foreach( $ekstra as $ekstra ) : ?> <!-- Mulai loop -->
                                            <?php 
                                                $no++;
                                            ?>
                                             <tr style="">
                                                <td style="box-shadow: 0px 0px 0px #400404;text-align: center;"><?php echo $no; ?></td>
                                                <td style="box-shadow: 0px 0px 0px #400404;"><?php echo $ekstra->jenis_kegiatan; ?></td>
                                                <td style="box-shadow: 0px 0px 0px #400404;text-align: center;"><?php echo $ekstra->hari; ?></td>
                                                <td style="box-shadow: 0px 0px 0px #400404;text-align: center;"><?php echo $ekstra->jam_mulai; ?> s/d <?php echo $ekstra->jam_selesai; ?></td>
                                            </tr>
                                            <?php endforeach; ?> <!-- Selesai loop -->
                                        </tbody>
                                    </table>
