        ...
        <div class="container services">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item" >
                     <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri;">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;"><?php echo $fa['nama_fasilitas'] ?></font></br></br>

                        <h3 style="font-family: Calibri;"><b><?php echo $fa['nama_fasilitas'] ?></b></h3></br>
                        <img class="card-img-top " src="<?=base_url()?>images/<?=$fa['gambar'];?>" style="width:100%; height: 300px;" alt="Card image cap">
                    <div class="">
                          <!-- <img src='<?=base_url()?>images/<?=$s->gambar;?>'></br></br> -->
                        <p>
                            <?php echo $fa['keterangan']; ?>
                        </p>
                    </div></br>
                </div>
