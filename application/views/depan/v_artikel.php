        ...
        <div class="container services" style="padding-top: 0px;">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item"  > 
                     <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri; ">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;">Artikel</font></br></br>
                    <h3 style="font-family: Calibri;"><b>Artikel</b></h3></br>
                    <div class="row">
                        <?php foreach( $data->result() as $a ) : ?> <!-- Mulai loop -->
                            ...
                            <div class="card" style="margin-bottom: 20px; border:0px; background-color: #edeff4">
                                <div class="row">
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="card-body">
                                        <b><p class="card-title" style="height: 60%; font-family: Calibri; font-size: 20px;"><?php echo $a->judul_artikel; ?></p></b>
                                        <img class="card-img-top " src="<?=base_url()?>images/<?=$a->gambar;?>" style="width:100%; height: 300px;" alt="Card image cap"></br></br>
                                          <!-- <h4 style="text-align: center; color: orange;"><?php echo $tgl; ?></h4> -->
                                          <p style="text-align: left; color: black;"><i class='fa fa-calendar-o'></i>&nbsp;<?php echo $tgl; ?>&nbsp;&nbsp; &nbsp;&nbsp;<i class="ti-eye"></i>&nbsp; <?php echo  $a->viewer;?>&nbsp;&nbsp; &nbsp;&nbsp;<i class="ti-user"></i>&nbsp;<a href="<?php echo base_url('login') ; ?>" style="">Admin</a></p></br>

                                          <p class="card-text" ><?php echo substr($a->isi_artikel ,0 ,500); ?>.....</p>
                                        
                                          <!-- <a href="<?php echo base_url('berita/update/'.$b->id_berita) ?>" class="btn btn-primary">Baca Selengkapnya</a> -->
                                            <form action="<?php echo base_url('artikel/update/'.$a->id_artikel) ?>" method="post">
                                                  <input type="hidden" name="id_artikel" value="<?php echo $a->id_artikel ?>">
                                                  <input type="hidden" name="viewer" value="<?php echo $a->viewer ?>">
                ...
                <div class="col-lg-4 col-sm-4 service-item" style="margin-top: 140px;">
                        ...
                        <div class="border1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-sm-8" style="">
                                     <a href="<?php echo base_url('berita/edit/'.$a->id_artikel) ?>"><?php echo $b->judul_berita; ?></a></br>
