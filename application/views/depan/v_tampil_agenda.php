        ...
        <div class="container services">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item"  style="">
                     <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri;">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp; <a href="<?php echo base_url('agenda') ; ?>" style="color: black; font-family: calibri;">Agenda</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;"><?php echo $a['judul_agenda'] ?></font></br></br>
                    <h3 style="font-family: Calibri;"><?php echo $a['judul_agenda'] ?></h3></br>
                    <div class="berita">
                        <center>
                            <img src="<?php echo base_url('images/'.$a['gambar']) ?>" style="width: 80%; height: 80%;">
                        </center></br></br>
                        <p style="text-align: left; color: green;"><i class='fas fa-calendar-alt'></i>&nbsp;&nbsp;<?php echo $a['tanggal_agenda'] ?></p>
                        <p><?php echo $a['keterangan_agenda'] ?></p>
                    </div>
                </div>
