   ...
   <nav class="nav-section">
    ...
    <section class="service-section spad">
        <div class="container services">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item" style="box-shadow: 0px 0px 0px #122e33;">
                    <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri;">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;">Sejarah</font></br></br>
                    <h3 style="font-family: Calibri;"><b>Sejarah Berdirinya</b></h3></br>
                    <div class="sejarah">
                       
                         <?php foreach( $sejarah as $s ) : ?> <!-- Mulai loop -->
                          <img src='<?=base_url()?>images/<?=$s->gambar;?>'></br>
                        <p>
                            <?php echo $s->isi_sejarah; ?>
                        </p>
                        <?php endforeach; ?> <!-- Selesai loop -->
                    </div>
                </div>
