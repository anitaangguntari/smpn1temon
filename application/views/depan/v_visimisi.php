        ...
        <div class="container services">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item" >
                    <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri;">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;">Visimisi</font></br></br>
                    <h3 style="font-family: Calibri;"><b>Visi</b></h3></br>
                    <div class="visi">
                        <?php foreach( $visimisi as $v ) : ?> <!-- Mulai loop -->
                     ...
                     <h3 style="font-family: Calibri;"><b>Misi</b></h3></br>
                    <div class="misi">
                         <?php foreach( $visimisi as $v ) : ?> <!-- Mulai loop -->
                          <!-- <img src='<?=base_url()?>images/<?=$s->gambar;?>'></br></br> -->
                        <p>
                   ...
                   <div class="col-lg-4 col-sm-4 service-item" style="margin-top: 70px;">
