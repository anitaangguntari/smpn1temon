        ...
        <div class="container services">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item"  style="">
                    <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri;">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;">Sambutan Kepala Sekolah</font></br></br>
                    <h3 style="font-family: Calibri;"><b>Sambutan Kepala Sekolah</b></h3></br>
                    <div class="sambutan">
                        <center>
                            <?php foreach( $guru as $gr ) : ?> <!-- Mulai loop -->
                              <img src="<?php echo base_url('images/'.$gr->foto_guru) ?>" style="width: 50%; height: 50%; box-shadow: 1px 1px 10px #020031;">
                            <?php endforeach; ?> <!-- Selesai loop -->
                        </center></br></br>
                        <p><?php echo $pf['isi_lainnya'] ?></p>
                    </div>
                </div>
