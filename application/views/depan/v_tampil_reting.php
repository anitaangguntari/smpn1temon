        ...
        <div class="container services">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item"  style="">
                     <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri;">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp; <a href="<?php echo base_url('artikel') ; ?>" style="color: black; font-family: calibri;">Artikel</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;">Tampil Rating</font></br></br>
                  
            		<h1>Penilaian</h1>
            		 <?php foreach( $reting as $r ) : ?> <!-- Mulai loop -->
            		 <div style="background-color: white; padding-left: 10px;">
            		 	<p>Pengguna : &nbsp;<?php echo $r->email ?>&nbsp;&nbsp;&nbsp; </p>
                        <b>Nilai : (<?php echo $r->rating ?>)</b>
            		 		  <?php
