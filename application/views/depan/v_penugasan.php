        ...
        <div class="container services">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item" > 
                    <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri;">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;">Penugasan</font></br></br>
                    <h3 style="font-family: Calibri; color: #000;"><b>Penugasan</b></h3></br>
                                <div class="table-responsive" style="background-color: white;">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
                                         <thead>
                                            <tr style="box-shadow: 0px 0px 0px #400404; text-align: center;">
                                                <th style="box-shadow: 0px 0px 0px #400404;">No</th>
                                                <th style="box-shadow: 0px 0px 0px #400404;">Mapel</th>
                                                <th style="box-shadow: 0px 0px 0px #400404;">Guru</th>
                                                <th style="box-shadow: 0px 0px 0px #400404;">Tugas</th>
                                                <th style="box-shadow: 0px 0px 0px #400404;">Keterangan</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php 
                                                $no=0;
                                            ?> 
                                            <?php foreach( $tugas as $t ) : ?> <!-- Mulai loop -->
                                            <?php 
                                                $no++;
                                            ?>
                                             <tr style="">
                                                <td style="box-shadow: 0px 0px 0px #400404;text-align: center;"><?php echo $no; ?></td>
                                                <td style="box-shadow: 0px 0px 0px #400404;"><?php echo $t->nama_mapel; ?></td>
                                                <td style="box-shadow: 0px 0px 0px #400404;text-align: center;"><?php echo $t->nama_guru; ?></td>
                                                <td style="box-shadow: 0px 0px 0px #400404;text-align: center;"><img src='<?=base_url()?>images/<?=$t->isi_tugas;?>' style=""></td>
                                                <td style="box-shadow: 0px 0px 0px #400404;text-align: center;"><?php echo $t->ket_tugas; ?></td>
                                            </tr>
                                            <?php endforeach; ?> <!-- Selesai loop -->
                                        </tbody>
                                    </table>
                   ...
                   <div class="col-lg-4 col-sm-4 service-item" style="margin-top: 115px;">
