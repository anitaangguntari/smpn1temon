        ...
        <div class="container services">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item" >
                     <div class="menu">
                        <b> <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri;">Home</a>&nbsp;&nbsp;<font style="color: grey;">|</font>&nbsp;&nbsp;<a href="<?php echo base_url('dapodik/rombel') ; ?>" style="color: black; font-family: calibri;">Data Rombel</a></b></br></br>
                    </div>
