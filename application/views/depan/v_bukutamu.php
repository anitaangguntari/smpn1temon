...
<style type="text/css">
body{
      /*background: url(assets/img/g.png) no-repeat center center fixed; 
   ...
   <nav class="nav-section">
    ...
    <section class="service-section spad">
        <div class="container services" style=" padding-top: 0px;">
             <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri;">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;">Buku Tamu</font></br></br>
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item" >
                    <div class="form" >
                    <h3 style=" color:white;font-family: Calibri; text-align: center; background-color: #337ab7; padding-left: 10px; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; margin-bottom: 0px; box-shadow: 1px 1px 3px #122e33;"><b>Form Buku Tamu</b></h3>
                       <form role="form" action="<?php echo base_url('bukutamu/tambah_aksi') ; ?>" method="post" style="box-shadow: 1px 1px 3px #122e33; background-color: white; padding-left: 10px; padding-top: 10px; padding-right: 10px; margin-top: 0px;">
                       
                            <div class="form-group">
                              <label class="control-label" for="inputSuccess">Nama </label>
                              <input type="text" class="form-control" id="inputSuccess" name="nama_tamu"  required="required">
                            </div>
                             <div class="form-group">
                              <label class="control-label" for="inputSuccess">Email</label>
                              <input type="email" class="form-control" id="inputSuccess" name="email"  required="required">
                            </div>
                            <div class="form-group">
                              <label class="control-label" for="inputSuccess">No Telp.</label>
                              <input type="number" class="form-control" id="inputSuccess" name="no_telp"  required="required">
                            </div>
                             <div class="form-group">
                              <label class="control-label" for="inputSuccess">Saran/Komentar</label>
                              <textarea type="text" class="form-control" id="inputSuccess" name="saran" rows ="10"></textarea>
                            </div>
                            
                            <div class="g-recaptcha" data-sitekey="6LcgWrUZAAAAANzJEd8Dw8ZKhg2l4WXgFxyTvVcN" style="margin-bottom: 30px;" align="center"></div>

                            <center>
                                  <button type="submit" class="btn btn-primary" style="margin-bottom: 20px;">Kirim</button>
                                  <input type="hidden" class="form-control" id="inputSuccess" name="id_tamu">
                            </center>
                        </form>
                                
                    </div>
                </div>
                   <div class="col-lg-4 col-sm-4 service-item" style="margin-top: 15px;">
