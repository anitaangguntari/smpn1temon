        ...
        <div class="container services">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item" >
                     <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri;">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;">Kurikulum</font></br></br>
                    <h3 style="font-family: Calibri;"><b>Kurikulum</b></h3></br>
                    <div class="visi">
                        <?php foreach( $kurikulum as $k ) : ?> <!-- Mulai loop -->
                          <!-- <img src='<?=base_url()?>images/<?=$s->gambar;?>'></br></br> -->
                        <p>
                            <?php echo $k->isi_kurikulum; ?>
                        </p>
                        <?php endforeach; ?> <!-- Selesai loop -->
                    </div></br>
                </div>
                   <div class="col-lg-4 col-sm-4 service-item" style="margin-top: 130px;">
