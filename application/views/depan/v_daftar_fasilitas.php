        ...
        <div class="container services" style="padding-top: 0px;">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item"  > 
                    ...
                    <h3 style="font-family: Calibri;"><b>Fasilitas</b></h3></br>
                    <div class="row">
                        <?php foreach( $data->result() as $f ) : ?> <!-- Mulai loop -->
                            <!-- viewer -->
                            ...
                            <div class="card" style="margin-bottom: 20px; border:0px; background-color: #edeff4">
                                <div class="row">
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="card-body">
                                        <b><p class="card-title" style="height: 60%; font-family: Calibri; font-size: 20px;"><?php echo $f->nama_fasilitas; ?></p></b>
                                        <img class="card-img-top " src="<?=base_url()?>images/<?=$f->gambar;?>" style="width:100%; height: 300px;" alt="Card image cap"></br></br>
                                          <!-- <h4 style="text-align: center; color: orange;"><?php echo $tgl; ?></h4> -->
                                          
                                          <p class="card-text" ><?php echo substr($f->keterangan ,0 ,300); ?>.....</p>
                                        
                                          <!-- <a href="<?php echo base_url('berita/update/'.$b->id_berita) ?>" class="btn btn-primary">Baca Selengkapnya</a> -->
                                            <form action="<?php echo base_url('artikel/update/'.$f->id_fasilitas) ?>" method="post">
                                                  <input type="hidden" name="id_artikel" value="<?php echo $f->id_fasilitas ?>">
                ...
                <div class="col-lg-4 col-sm-4 service-item" style="margin-top: 170px;">
                    ...
                    <div class="kanan" style="">
                        ...
                        <div class="border1">
                            <!--  <div class="row">
                                ...
                                <div class="col-lg-10 col-sm-1" style="padding-left: 0px;">
