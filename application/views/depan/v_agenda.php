        ...
        <div class="container services">
            <div class="row">
                <div class="col-lg-8 col-sm-8 service-item" > 
                     <a href="<?php echo base_url('') ; ?>" style="color: black; font-family: calibri;">Home</a>&nbsp;&nbsp;<font style="color: grey;">/</font>&nbsp;&nbsp;<font style="font-family: calibri;">Agenda</font></br></br>
                    <h3 style="font-family: Calibri;"><b>Agenda</b></h3></br>
                    <?php foreach( $data->result() as $a ) : ?> <!-- Mulai loop -->
                    <div class="card">
                        <div class="card-body">
                            <h5 style="color: orange;"><i class="fa fa-calendar"></i>&nbsp;<?php echo $a->tanggal_agenda; ?></h5>
                            <p class="card-title" style="font-family: Calibri; font-size: 22px;"><a href="<?php echo base_url('agenda/edit/'.$a->id_agenda) ?>" style="color:black;"><?php echo $a->judul_agenda; ?></a></p></br>
                            <p class="card-text"><?php echo substr($a->keterangan_agenda ,0 ,300); ?>.....</p>
                        </div>
                    </div> 
                    <hr size="10px">
                    <?php endforeach; ?> <!-- Selesai loop -->
