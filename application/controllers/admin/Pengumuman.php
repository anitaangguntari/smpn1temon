...
class Pengumuman extends CI_Controller{
    ...
    function index(){
        ...
        $this->load->view('admin/admin/v_daftar_pengumuman',$data);
    ...
    function tambah(){
        $id = 1;
        $data['profil']= $this->m_profil->db_edit($id)->row_array();
        $this->load->view('admin/admin/v_tambah_pengumuman', $data);
        // echo $this->db->last_query();
    }
    ...
    function edit($id)
    {
        ...
        // echo $this->db->last_query();
        $this->load->view('admin/admin/v_edit_pengumuman', $data);
    }
