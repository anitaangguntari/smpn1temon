...
class Mapel extends CI_Controller{
 ...
 function index(){
 	 $id = 1;
        ...
        $this->load->view('admin/guru/v_daftar_mapel', $data);
  ...
  function tambah(){
  	 $id = 1;
        ...
        $this->load->view('admin/guru/v_tambah_mapel', $this->data);
    }
 ...
 //    	$data['kelas'] = $this->m_mapel->getKelas();
	 ...
	 function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('gru/mapel');
        ...
        $this->load->view("admin/guru/v_edit_mapel", $data);
    }
