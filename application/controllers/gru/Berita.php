...
class Berita extends CI_Controller{
    ...
    function index(){
        ...
        $this->load->view('admin/guru/v_daftar_berita',$data);
    ...
    function tambah(){
         $id = 1;
        $data['profil']= $this->m_profil->db_edit($id)->row_array();
        $this->load->view('admin/guru/v_tambah_berita', $data);
    }
  ...
  function edit($id)
     {
        ...
        $this->load->view('admin/guru/v_edit_berita',$dt);
      }   
